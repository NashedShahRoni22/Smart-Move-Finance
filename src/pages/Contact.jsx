        ...
        <div className="lg:w-1/2">
          ...
          <div className="">
            ...
            <form action="" className="mt-5">
              ...
              <button
                type="submit"
                className="px-4 md:px-6 py-2 md:py-4 text-xs md:text-base bg-primary border border-primary hover:bg-white text-white hover:text-primary duration-300 ease-linear rounded-full"
              >
                Send Message
              </button>
            </form>
